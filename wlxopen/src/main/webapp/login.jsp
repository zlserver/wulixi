	...
	<div class="row-fluid">
		...
		<form method="post" action='<c:url value="/common/login.uhtml" />' class="form-horizontal" style="width: 500px;">
			<div align="center" class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" value="admin${formbean.admin.account }"   required="required" class="form-control" id="account" name="admin.account">
				    </div>
			</div>
			<div class="form-group">
				<label for="inputPassword" class="col-sm-2 control-label">密码</label>
				<div class="col-sm-8">
					<input type="password" value="Admin68902660${formbean.admin.password}"   required="required" class="form-control" id="password" name="admin.password">
					</div>
			</div>
			<div class="form-group">
